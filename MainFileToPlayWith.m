...
%load('DataforSVMOWn'); % Load the data file with training data
%[trainedClassifier, validationAccuracy] = kNN84Percent(Z);
%Train the model with the data again
...
%         fprintf('%.1f\t',chunk(:,s));
        ...
        % Need to change the rate for proper outputting
        % Servo cant change every ms, probably end up breaking it :P
